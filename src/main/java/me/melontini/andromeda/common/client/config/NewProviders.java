...
public class NewProviders {
  ...
  static void init() {
    Set.of(int.class, Integer.class).forEach(cl -> builder(
            cl,
            (type, value, def, setter, i18n, context) -> ENTRY_BUILDER
                .startIntField(i18n(i18n, context), value)
    ...
    Set.of(boolean.class, Boolean.class).forEach(cl -> builder(
            cl,
            (type, value, def, setter, i18n, context) -> ENTRY_BUILDER
                .startBooleanToggle(i18n(i18n, context), value)
                .setDefaultValue((def == null || context.generic()) ? null : () -> def)
                .setSaveConsumer(setter)
                .build(),
            (c) -> false)
    ...
    Set.of(double.class, Double.class).forEach(cl -> builder(
            cl,
            (type, value, def, setter, i18n, context) -> ENTRY_BUILDER
                .startDoubleField(i18n(i18n, context), value)
                .setDefaultValue((def == null || context.generic()) ? null : () -> def)
                .setSaveConsumer(setter)
                .build(),
            (c) -> 0d)
    ...
    builder(
            String.class,
            (type, value, def, setter, i18n, context) -> ENTRY_BUILDER
                .startStrField(i18n(i18n, context), value)
                .setDefaultValue((def == null || context.generic()) ? null : () -> def)
                .setSaveConsumer(setter)
                .build(),
            (c) -> "")
    ...
    builder(
            Identifier.class,
            (type, value, def, setter, i18n, context) -> ENTRY_BUILDER
                .startStrField(i18n(i18n, context), value.toString())
                .setDefaultValue((def == null || context.generic()) ? null : def::toString)
                .setSaveConsumer(s -> setter.accept(new Identifier(s)))
                .build(),
            (c) -> new Identifier(""))
    ...
    NewAutoConfigScreen.<List<Object>>builder(
            aClass -> List.class == aClass,
            (type, value, def, setter, i18n, context) -> {
              if (context.field() == null) return null;
              Class<?> fieldType =
                  (Class<?>) ((ParameterizedType) context.field().getGenericType())
                      .getActualTypeArguments()[0];
              var e = NewAutoConfigScreen.getProviders().entrySet().stream()
                  .filter(me -> me.getKey().test(fieldType))
                  .findFirst()
                  .map(Map.Entry::getValue)
                  .orElse(NewAutoConfigScreen.defaultProvider());
              NewAutoConfigScreen.Context context1 = context.withGeneric(true);
              var r = new NestedListListEntry<>(
                  TextUtil.translatable(i18n),
                  value.stream()
                      .map(object -> e.converters().toBase().apply(object))
                      .toList(),
                  false,
                  null,
                  objects -> setter.accept(objects.stream()
                      .map(object -> e.converters().fromBase().apply(object))
                      .toList()),
                  def == null
                      ? null
                      : () -> def.stream()
                  ...
                  true,
                  false,
                  (object, entry) -> (AbstractConfigListEntry<Object>) e.provider()
                      .getEntry(
                          fieldType,
                          object == null
                              ? e.def().apply(fieldType)
                              : e.converters().fromBase().apply(object),
                          e.def().apply(fieldType),
                          o -> {},
                          i18n,
                          context1));
    ...
    NewAutoConfigScreen.<Enum<?>>builder(
            aClass -> aClass.isEnum() || Enum.class.isAssignableFrom(aClass),
            (type, value, def, setter, i18n, context) -> {
              List<Enum<?>> enums =
                      ...
                      DropdownMenuBuilder.TopCellElementBuilder.of(
                          ...
                          (str) -> {
                            for (Enum<?> anEnum : enums) {
                              if (DEFAULT_NAME_PROVIDER
                                  .apply(anEnum)
                                  .getString()
                                  .equals(str)) return anEnum;
                            }
                            return null;
                          },
            ...
            aClass ->
                Exceptions.supply(() -> ((Enum<?>[]) aClass.getMethod("values").invoke(null)))[0])
        .build();
    ...
    Runnable commander = Support.support(
        "commander",
        () -> NewProviders::commanderIntermediaries,
        () -> NewProviders::constantIntermediaries);
    commander.run();
  }
  ...
  private static <T> void forRegistry(Class<T> type, Registry<T> registry, Supplier<T> supplier) {
    builder(
            type,
            (type1, value, def, setter, i18n, context) -> {
              ...
              return ENTRY_BUILDER
                  .startStrField(i18n(i18n, context), val)
                  .setDefaultValue((def == null || context.generic()) ? null : () -> newDef)
                  .setSaveConsumer(s -> setter.accept(registry.get(new Identifier(s))))
                  .build();
            },
            c -> supplier.get())
        .converter(
            (String s) -> registry.get(new Identifier(s)),
  ...
  private static void constantIntermediaries() {
    builder(
            ...
            (type, value, def, setter, i18n, context) -> ENTRY_BUILDER
                .startDoubleField(i18n(i18n, context), value.asDouble(null))
                .setDefaultValue(
                    (def == null || context.generic()) ? null : () -> def.asDouble(null))
                .setSaveConsumer((newValue) -> setter.accept(DoubleIntermediary.of(newValue)))
                .build(),
            (c) -> DoubleIntermediary.of(0))
        .converter(DoubleIntermediary::of, i -> Andromeda.GAME_HANDLER
            .getGson()
            .toJsonTree(i, DoubleIntermediary.class)
            .getAsJsonPrimitive()
            .getAsDouble())
        .build();
    ...
    builder(
            ...
            (type, value, def, setter, i18n, context) -> ENTRY_BUILDER
                .startLongField(i18n(i18n, context), value.asLong(null))
                .setDefaultValue((def == null || context.generic()) ? null : () -> def.asLong(null))
                .setSaveConsumer((newValue) -> setter.accept(LongIntermediary.of(newValue)))
                .build(),
            (c) -> LongIntermediary.of(0))
        .converter(LongIntermediary::of, i -> Andromeda.GAME_HANDLER
            .getGson()
            .toJsonTree(i, LongIntermediary.class)
            .getAsJsonPrimitive()
            .getAsLong())
        .build();
    ...
    builder(
            ...
            (type, value, def, setter, i18n, context) -> ENTRY_BUILDER
                .startBooleanToggle(i18n(i18n, context), value.asBoolean(null))
                .setDefaultValue(
                    (def == null || context.generic()) ? null : () -> def.asBoolean(null))
                .setSaveConsumer((newValue) -> setter.accept(BooleanIntermediary.of(newValue)))
                .build(),
            (c) -> BooleanIntermediary.of(false))
        .converter(BooleanIntermediary::of, i -> Andromeda.GAME_HANDLER
            .getGson()
            .toJsonTree(i, BooleanIntermediary.class)
            .getAsJsonPrimitive()
            .getAsBoolean())
        .build();
  }
  ...
  private static void commanderIntermediaries() {
    Function<String, DoubleIntermediary> toNumber = (String str) -> {
      try {
        ...
        return Andromeda.GAME_HANDLER
            .getGson()
            .fromJson(new JsonPrimitive(str), DoubleIntermediary.class);
      }
    };
    builder(
            DoubleIntermediary.class,
            (type, value, def, setter, i18n, context) -> {
              var p = Andromeda.GAME_HANDLER
                  .getGson()
                  .toJsonTree(value, DoubleIntermediary.class)
                  .getAsJsonPrimitive();
              var p1 = (def == null || context.generic())
                  ? null
                  : Andromeda.GAME_HANDLER
                      .getGson()
                      .toJsonTree(def, DoubleIntermediary.class)
                      .getAsJsonPrimitive();

              return ENTRY_BUILDER
                  .startStrField(i18n(i18n, context), p.getAsString())
                  .setDefaultValue(p1 == null ? null : p1::getAsString)
                  .setSaveConsumer((newValue) -> setter.accept(toNumber.apply(newValue)))
                  .build();
            },
            (c) -> DoubleIntermediary.of(0))
        .converter(toNumber, i -> Andromeda.GAME_HANDLER
            .getGson()
            .toJsonTree(i, DoubleIntermediary.class)
            .getAsJsonPrimitive()
            .getAsString())
    ...
    Function<String, LongIntermediary> toLong = (String str) -> {
      try {
        ...
        return Andromeda.GAME_HANDLER
            .getGson()
            .fromJson(new JsonPrimitive(str), LongIntermediary.class);
      }
    };
    builder(
            LongIntermediary.class,
            (type, value, def, setter, i18n, context) -> {
              var p = Andromeda.GAME_HANDLER
                  .getGson()
                  .toJsonTree(value, LongIntermediary.class)
                  .getAsJsonPrimitive();
              var p1 = (def == null || context.generic())
                  ? null
                  : Andromeda.GAME_HANDLER
                      .getGson()
                      .toJsonTree(def, LongIntermediary.class)
                      .getAsJsonPrimitive();

              return ENTRY_BUILDER
                  .startStrField(i18n(i18n, context), p.getAsString())
                  .setDefaultValue(p1 == null ? null : p1::getAsString)
                  .setSaveConsumer((newValue) -> setter.accept(toLong.apply(newValue)))
                  .build();
            },
            (c) -> LongIntermediary.of(0))
        .converter(toLong, i -> Andromeda.GAME_HANDLER
            .getGson()
            .toJsonTree(i, LongIntermediary.class)
            .getAsJsonPrimitive()
            .getAsString())
    ...
    Function<String, BooleanIntermediary> toBoolean = (String str) -> {
      ...
      return Andromeda.GAME_HANDLER
          .getGson()
          .fromJson(new JsonPrimitive(str), BooleanIntermediary.class);
    };
    builder(
            BooleanIntermediary.class,
            (type, value, def, setter, i18n, context) -> {
              var p = Andromeda.GAME_HANDLER
                  .getGson()
                  .toJsonTree(value, BooleanIntermediary.class)
                  .getAsJsonPrimitive();
              var p1 = (def == null || context.generic())
                  ? null
                  : Andromeda.GAME_HANDLER
                      .getGson()
                      .toJsonTree(def, BooleanIntermediary.class)
                      .getAsJsonPrimitive();

              return ENTRY_BUILDER
                  .startStrField(i18n(i18n, context), p.getAsString())
                  .setDefaultValue(p1 == null ? null : p1::getAsString)
                  .setSaveConsumer((newValue) -> setter.accept(toBoolean.apply(newValue)))
                  .build();
            },
            (c) -> BooleanIntermediary.of(false))
        .converter(toBoolean, i -> Andromeda.GAME_HANDLER
            .getGson()
            .toJsonTree(i, BooleanIntermediary.class)
            .getAsJsonPrimitive()
            .getAsString())
  ...
  private static String untilNotNull(Throwable throwable) {
    if (throwable.getMessage() == null)
      return throwable.getCause() != null ? untilNotNull(throwable) : null;
