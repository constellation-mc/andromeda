...
public final class FeatureBlockade {
    ...
    private final IdentityHashMap<Module, Map<String, Tuple<Set<Text>, Predicate<ModuleManager>>>> blockades = new IdentityHashMap<>();
    ...
    public FeatureBlockade explain(Module module, String feature, Predicate<ModuleManager> predicate, String key) {
