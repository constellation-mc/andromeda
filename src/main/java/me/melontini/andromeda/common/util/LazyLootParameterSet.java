...
public class LazyLootParameterSet extends LootContextParameterSet {
  ...
  public LazyLootParameterSet(
      Supplier<ServerWorld> world,
      Map<LootContextParameter<?>, Supplier<Object>> parameters,
      Map<Identifier, DynamicDrop> dynamicDrops,
      float luck) {
