...
public class SpikeCacheMixin {
    ...
    private int andromeda$modifySpikeSize(int size) {
        if (Andromeda.CONFIG.dragonFight.fightTweaks && Andromeda.CONFIG.dragonFight.shorterSpikes) return 72;
        return size;
    }
    ...
    private int andromeda$modifySpikeHeight(int size) {
        if (Andromeda.CONFIG.dragonFight.fightTweaks && Andromeda.CONFIG.dragonFight.shorterSpikes) return 2;
        return size;
    }
}
