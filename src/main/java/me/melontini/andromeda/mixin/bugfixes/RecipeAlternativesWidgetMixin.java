...
public class RecipeAlternativesWidgetMixin {
    ...
    private int andromeda$prepareGrid(int i) {
        return Andromeda.CONFIG.properlyAlignedRecipeAlternatives ? 25 : i;
    }
    ...
    private int andromeda$renderGridX(RecipeAlternativesWidget instance) {
        return Andromeda.CONFIG.properlyAlignedRecipeAlternatives ? this.buttonX - 2 : this.buttonX;
    }
    ...
    private int andromeda$renderGridY(RecipeAlternativesWidget instance) {
        return Andromeda.CONFIG.properlyAlignedRecipeAlternatives ? this.buttonY - 1 : this.buttonY;
    }
}
