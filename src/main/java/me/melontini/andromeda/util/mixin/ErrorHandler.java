...
public class ErrorHandler implements IMixinErrorHandler {
    ...
    public ErrorAction onPrepareError(IMixinConfig config, Throwable th, IMixinInfo mixin, ErrorAction action) {
        return handleMixinError("prepare", mixin, action);
    }

    @Override
    public ErrorAction onApplyError(String targetClassName, Throwable th, IMixinInfo mixin, ErrorAction action) {
        return handleMixinError("apply", mixin, action);
    }

    private static ErrorAction handleMixinError(String phase, IMixinInfo mixin, ErrorAction action) {
