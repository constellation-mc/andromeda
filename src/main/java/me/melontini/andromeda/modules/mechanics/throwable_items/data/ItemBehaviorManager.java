...
public class ItemBehaviorManager extends IdentifiedJsonDataLoader {
  ...
  public static final ReloaderType<ItemBehaviorManager> RELOADER =
      ReloaderType.create(id("item_throw_behaviors"));
  ...
  private final Object2ObjectMap<Item, Arithmetica> customCooldowns =
      Utilities.supply(new Object2ObjectOpenHashMap<>(), map -> {
  ...
  protected void apply(
    ...
    Maps.transformValues(data, input -> ItemBehaviorData.create(input.getAsJsonObject()))
