...
public record ColoredStackLandedPayload(ItemStack dye) implements CustomPayload {
  ...
  public static final PacketCodec<RegistryByteBuf, ColoredStackLandedPayload> CODEC =
      PacketCodec.tuple(
          ItemStack.PACKET_CODEC, ColoredStackLandedPayload::dye, ColoredStackLandedPayload::new);
