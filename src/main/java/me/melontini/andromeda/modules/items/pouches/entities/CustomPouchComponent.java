...
public record CustomPouchComponent(RegistryKey<LootTable> key) {
  ...
  public static final CustomPouchComponent DEFAULT = new CustomPouchComponent(
      RegistryKey.of(RegistryKeys.LOOT_TABLE, Andromeda.id("pouches/seeds")));
  public static final Codec<CustomPouchComponent> CODEC = RegistryKey.createCodec(
          RegistryKeys.LOOT_TABLE)
      .fieldOf("loot_table")
      .xmap(CustomPouchComponent::new, CustomPouchComponent::key)
      .codec();
  public static final PacketCodec<ByteBuf, CustomPouchComponent> PACKET_CODEC =
