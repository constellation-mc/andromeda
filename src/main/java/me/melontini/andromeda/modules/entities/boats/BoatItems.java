    ...
    for (BoatEntity.Type value : BoatEntity.Type.values()) {
      Optional.ofNullable(RegistryUtil.register(
              ...
              () -> new AndromedaBoatItem<>(
                  BoatEntities.BOAT_WITH_FURNACE, value, new Item.Settings().maxCount(1))))
          .ifPresent(list::add);
      ...
      Optional.ofNullable(RegistryUtil.register(
              ...
              () -> new AndromedaBoatItem<>(
                  BoatEntities.BOAT_WITH_JUKEBOX, value, new Item.Settings().maxCount(1))))
          .ifPresent(list::add);
      ...
      Optional.ofNullable(RegistryUtil.register(
              ...
              boatId(value, "tnt"),
              () -> new AndromedaBoatItem<>(
                  BoatEntities.BOAT_WITH_TNT, value, new Item.Settings().maxCount(1))))
          .ifPresent(list::add);
      ...
      Optional.ofNullable(RegistryUtil.register(
              ...
              boatId(value, "hopper"),
              () -> new AndromedaBoatItem<>(
                  BoatEntities.BOAT_WITH_HOPPER, value, new Item.Settings().maxCount(1))))
          .ifPresent(list::add);
    }
