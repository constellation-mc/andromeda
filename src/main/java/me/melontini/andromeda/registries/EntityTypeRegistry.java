...
public class EntityTypeRegistry {
    public static EntityType<AnvilMinecartEntity> ANVIL_MINECART_ENTITY = RegistryUtil.createEntityType(Andromeda.CONFIG.newMinecarts.isAnvilMinecartOn, new Identifier(MODID, "anvil_minecart"), FabricEntityTypeBuilder.<AnvilMinecartEntity>create(SpawnGroup.MISC, AnvilMinecartEntity::new).dimensions(new EntityDimensions(0.98F, 0.7F, true)));
    public static EntityType<NoteBlockMinecartEntity> NOTEBLOCK_MINECART_ENTITY = RegistryUtil.createEntityType(Andromeda.CONFIG.newMinecarts.isNoteBlockMinecartOn, new Identifier(MODID, "note_block_minecart"), FabricEntityTypeBuilder.<NoteBlockMinecartEntity>create(SpawnGroup.MISC, NoteBlockMinecartEntity::new).dimensions(new EntityDimensions(0.98F, 0.7F, true)));
    public static EntityType<JukeboxMinecartEntity> JUKEBOX_MINECART_ENTITY = RegistryUtil.createEntityType(Andromeda.CONFIG.newMinecarts.isJukeboxMinecartOn, new Identifier(MODID, "jukebox_minecart"), FabricEntityTypeBuilder.<JukeboxMinecartEntity>create(SpawnGroup.MISC, JukeboxMinecartEntity::new).dimensions(new EntityDimensions(0.98F, 0.7F, true)));
    public static EntityType<TNTBoatEntity> BOAT_WITH_TNT = RegistryUtil.createEntityType(Andromeda.CONFIG.newBoats.isTNTBoatOn, new Identifier(MODID, "tnt_boat"), FabricEntityTypeBuilder.<TNTBoatEntity>create(SpawnGroup.MISC, TNTBoatEntity::new).dimensions(new EntityDimensions(1.375F, 0.5625F, true)));
    ...
    public static EntityType<ChestBoatEntity> BOAT_WITH_CHEST = RegistryUtil.createEntityType(Andromeda.CONFIG.newBoats.isChestBoatOn, new Identifier(MODID, "chest_boat"), FabricEntityTypeBuilder.<ChestBoatEntity>create(SpawnGroup.MISC, ChestBoatEntity::new).dimensions(new EntityDimensions(1.375F, 0.5625F, true)));
