...
public class EntityTypeRegistry {
    ...
    public static EntityType<FlyingItemEntity> FLYING_ITEM = RegistryUtil.createEntityType(Andromeda.CONFIG.throwableItems, new Identifier(MODID, "flying_item"), FabricEntityTypeBuilder.<FlyingItemEntity>create(SpawnGroup.MISC, FlyingItemEntity::new)
