...
public class EntityTypeRegistry {
    ...
    public EntityType<AnvilMinecartEntity> ANVIL_MINECART_ENTITY = RegistryUtil.createEntityType(Config.get().newMinecarts.isAnvilMinecartOn, new Identifier(MODID, "anvil_minecart"),
    ...
    public EntityType<NoteBlockMinecartEntity> NOTEBLOCK_MINECART_ENTITY = RegistryUtil.createEntityType(Config.get().newMinecarts.isNoteBlockMinecartOn, new Identifier(MODID, "note_block_minecart"),
    ...
    public EntityType<JukeboxMinecartEntity> JUKEBOX_MINECART_ENTITY = RegistryUtil.createEntityType(Config.get().newMinecarts.isJukeboxMinecartOn, new Identifier(MODID, "jukebox_minecart"),
    ...
    public EntityType<TNTBoatEntity> BOAT_WITH_TNT = RegistryUtil.createEntityType(Config.get().newBoats.isTNTBoatOn, new Identifier(MODID, "tnt_boat"),
    ...
    public EntityType<FurnaceBoatEntity> BOAT_WITH_FURNACE = RegistryUtil.createEntityType(Config.get().newBoats.isFurnaceBoatOn, new Identifier(MODID, "furnace_boat"),
    ...
    public EntityType<JukeboxBoatEntity> BOAT_WITH_JUKEBOX = RegistryUtil.createEntityType(Config.get().newBoats.isJukeboxBoatOn, new Identifier(MODID, "jukebox_boat"),
    ...
    public EntityType<HopperBoatEntity> BOAT_WITH_HOPPER = RegistryUtil.createEntityType(Config.get().newBoats.isHopperBoatOn, new Identifier(MODID, "hopper_boat"),
    ...
    public EntityType<FlyingItemEntity> FLYING_ITEM = RegistryUtil.createEntityType(new Identifier(MODID, "flying_item"),
