...
public class EntityTypeRegistry {
    ...
    public static EntityType<AnvilMinecartEntity> ANVIL_MINECART_ENTITY = RegistryUtil.createEntityType(Config.get().newMinecarts.isAnvilMinecartOn, new Identifier(MODID, "anvil_minecart"),
    ...
    public static EntityType<NoteBlockMinecartEntity> NOTEBLOCK_MINECART_ENTITY = RegistryUtil.createEntityType(Config.get().newMinecarts.isNoteBlockMinecartOn, new Identifier(MODID, "note_block_minecart"),
    ...
    public static EntityType<JukeboxMinecartEntity> JUKEBOX_MINECART_ENTITY = RegistryUtil.createEntityType(Config.get().newMinecarts.isJukeboxMinecartOn, new Identifier(MODID, "jukebox_minecart"),
    ...
    public static EntityType<TNTBoatEntity> BOAT_WITH_TNT = RegistryUtil.createEntityType(Config.get().newBoats.isTNTBoatOn, new Identifier(MODID, "tnt_boat"),
    ...
    public static EntityType<FurnaceBoatEntity> BOAT_WITH_FURNACE = RegistryUtil.createEntityType(Config.get().newBoats.isFurnaceBoatOn, new Identifier(MODID, "furnace_boat"),
    ...
    public static EntityType<JukeboxBoatEntity> BOAT_WITH_JUKEBOX = RegistryUtil.createEntityType(Config.get().newBoats.isJukeboxBoatOn, new Identifier(MODID, "jukebox_boat"),
    ...
    public static EntityType<HopperBoatEntity> BOAT_WITH_HOPPER = RegistryUtil.createEntityType(Config.get().newBoats.isHopperBoatOn, new Identifier(MODID, "hopper_boat"),
