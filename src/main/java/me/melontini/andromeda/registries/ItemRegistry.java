...
public class ItemRegistry {
    ...
    public final SpawnerMinecartItem SPAWNER_MINECART = ContentBuilder.ItemBuilder
            ...
            .itemGroup(call(() -> Registries.ITEM_GROUP.get(ItemGroups.REDSTONE))).build();
    ...
    public final AnvilMinecartItem ANVIL_MINECART = ContentBuilder.ItemBuilder
            ...
            .itemGroup(call(() -> Registries.ITEM_GROUP.get(ItemGroups.REDSTONE))).register(Config.get().newMinecarts.isAnvilMinecartOn).build();
    ...
    public final NoteBlockMinecartItem NOTE_BLOCK_MINECART = ContentBuilder.ItemBuilder
            ...
            .itemGroup(call(() -> Registries.ITEM_GROUP.get(ItemGroups.REDSTONE))).register(Config.get().newMinecarts.isNoteBlockMinecartOn).build();
    ...
    public final JukeBoxMinecartItem JUKEBOX_MINECART = ContentBuilder.ItemBuilder
            ...
            .itemGroup(call(() -> Registries.ITEM_GROUP.get(ItemGroups.REDSTONE))).register(Config.get().newMinecarts.isJukeboxMinecartOn).build();
    ...
    public final Item INFINITE_TOTEM = ContentBuilder.ItemBuilder
            ...
            .itemGroup(call(() -> Registries.ITEM_GROUP.get(ItemGroups.COMBAT))).register(Config.get().totemSettings.enableInfiniteTotem).build();
    ...
    public final Item LOCKPICK = ContentBuilder.ItemBuilder
            ...
            .itemGroup(call(() -> Registries.ITEM_GROUP.get(ItemGroups.TOOLS))).register(Config.get().lockpickEnabled).build();
