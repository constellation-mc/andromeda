...
public class ItemRegistry {
    ...
    public static SpawnerMinecartItem SPAWNER_MINECART = ContentBuilder.ItemBuilder.create(SpawnerMinecartItem.class, new Identifier(MODID, "spawner_minecart"), AbstractMinecartEntity.Type.SPAWNER, new FabricItemSettings())
            .maxCount(1).itemGroup(ItemGroups.REDSTONE).build();
    public static AnvilMinecartItem ANVIL_MINECART = ContentBuilder.ItemBuilder.create(AnvilMinecartItem.class, new Identifier(MODID, "anvil_minecart"), new FabricItemSettings())
            .maxCount(1).itemGroup(ItemGroups.REDSTONE).loadCondition(Andromeda.CONFIG.newMinecarts.isAnvilMinecartOn).build();
    public static NoteBlockMinecartItem NOTE_BLOCK_MINECART = ContentBuilder.ItemBuilder.create(NoteBlockMinecartItem.class, new Identifier(MODID, "note_block_minecart"), new FabricItemSettings())
            .maxCount(1).itemGroup(ItemGroups.REDSTONE).loadCondition(Andromeda.CONFIG.newMinecarts.isNoteBlockMinecartOn).build();
    public static JukeBoxMinecartItem JUKEBOX_MINECART = ContentBuilder.ItemBuilder.create(JukeBoxMinecartItem.class, new Identifier(MODID, "jukebox_minecart"), new FabricItemSettings())
            .maxCount(1).itemGroup(ItemGroups.REDSTONE).loadCondition(Andromeda.CONFIG.newMinecarts.isJukeboxMinecartOn).build();
    public static Item INFINITE_TOTEM = ContentBuilder.ItemBuilder.create(Item.class, new Identifier(MODID, "infinite_totem"), new FabricItemSettings())
            .maxCount(1).rarity(Rarity.EPIC).itemGroup(ItemGroups.COMBAT).loadCondition(Andromeda.CONFIG.totemSettings.enableInfiniteTotem).build();
    ...
    public static void register() {
        for (BoatEntity.Type value : BoatEntity.Type.values()) {
            createItem(Andromeda.CONFIG.newBoats.isFurnaceBoatOn, FurnaceBoatItem.class, new Identifier(MODID, value.getName().replace(":", "_") + "_boat_with_furnace"), ItemGroups.TOOLS, value, new FabricItemSettings().maxCount(1));
            createItem(Andromeda.CONFIG.newBoats.isJukeboxBoatOn, JukeboxBoatItem.class, new Identifier(MODID, value.getName().replace(":", "_") + "_boat_with_jukebox"), ItemGroups.TOOLS, value, new FabricItemSettings().maxCount(1));
            createItem(Andromeda.CONFIG.newBoats.isTNTBoatOn, TNTBoatItem.class, new Identifier(MODID, value.getName().replace(":", "_") + "_boat_with_tnt"), ItemGroups.TOOLS, value, new FabricItemSettings().maxCount(1));
            createItem(Andromeda.CONFIG.newBoats.isHopperBoatOn, HopperBoatItem.class, new Identifier(MODID, value.getName().replace(":", "_") + "_boat_with_hopper"), ItemGroups.TOOLS, value, new FabricItemSettings().maxCount(1));
        }
