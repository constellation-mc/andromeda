...
public class BlitRenderStateMixin {
  ...
  @WrapOperation(
      at =
          @At(
              value = "FIELD",
              target = "Lnet/minecraft/client/gui/render/state/BlitRenderState;color:I",
  ...
  private void modifyColor(BlitRenderState instance, int value, Operation<Void> original) {
